...
import {
  ListView, View, TouchableOpacity, Image, StyleSheet,
} from 'react-native';
import { actions } from './const';

const defaultActions = [actions.insertImage, actions.setBold, actions.setItalic, actions.insertBulletsList, actions.insertOrderedList, actions.insertLink];
...
export default class RichTextToolbar extends Component {
  ...
  _defaultRenderAction(action, selected) {
    ...
    return (
      <TouchableOpacity
        key={action}
        style={[{ height: 50, width: 50, justifyContent: 'center' }, selected ? this._getButtonSelectedStyle() : this._getButtonUnselectedStyle()]}
